...
async function externalImport(id) {
  ...
  case "next/dist/compiled/@vercel/og/index.node.js":
    ...
    break;
  case "gray-matter-5314f979e39e320e":
    raw = await import("gray-matter");
    break;
  case "rehype-raw-0a30da69abca80ee":
    raw = await import("rehype-raw");
    break;
  case "rehype-stringify-ee274d5706faae31":
    raw = await import("rehype-stringify");
    break;
  case "remark-5fbce4b045965e45":
    raw = await import("remark");
    break;
  case "remark-html-13543590587fb727":
    raw = await import("remark-html");
    break;
  case "remark-rehype-5ec4512fb04ed697":
    raw = await import("remark-rehype");
    break;
  default:
    raw = await import(id);
};
